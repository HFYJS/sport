 ...
 */
@WebServlet("/GetShopDetailBySidServlet")
public class GetShopDetailBySidServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public GetShopDetailBySidServlet() {
		super();
	...
	protected void doGet(HttpServletRequest request,
		...
		List<Goods> goodses = goodsService.getAllGoodsesBySid(sid);
