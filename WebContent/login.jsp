...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
	<script type="text/javascript" src="/sport/js/jquery-1.9.0.min.js"></script>
	<script type="text/javascript" src="/sport/images/login.js"></script>
	<link href="/sport/css/login2.css" rel="stylesheet" type="text/css" />
	<script>
			...
			<div class="web_login" id="web_login">
				...
				<div class="login-box">
					...
					<div class="login_form">
						<form action="/sport/LoginServlet" name="loginform"
